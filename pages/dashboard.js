import { Box, Container, Divider, Text, Flex, Heading, Link } from "@chakra-ui/react";
  ...
  return (
    <Box background={"black"} minH={"100vh"}>
      <Container maxW="container.lg">
        <Flex width={"100%"} py={4} justifyContent={"space-between"} alignItems={"center"} flexDirection={"row"}>
        ...
        <Divider mb={8} />
        <Text fontSize={"3xl"} color={"white"}>Dashboard</Text>
      </Container>
    </Box>
  );
};
